...
/** @description Ссылка для скачивания календаря */
export const calendarUrl = ''
/** @description Время, через которое нужно скачивать календарь */
...
/** @description Пароль базы данных Postgres */
export const pgPass = 'example'